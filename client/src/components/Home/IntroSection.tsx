      ...
      <div className="min-h-main w-full grid justify-center items-center md:grid-cols-2">
          ...
          <div className="clip-path max-h-[calc(100vh - 66px)] h-full md:flex hidden overflow-hidden">
            <IntroCarousel >
                ...
                <IntroSlide>
                  <div style={styleBg("CoU-BRACNet.jpg", "center")} className="intro-bg w-full" />
                </IntroSlide>
                
                <IntroSlide>
                  <div style={styleBg("Intro_image_1.jpg", "center")} className="intro-bg w-full" />
                </IntroSlide>
          ...
          <div className="md:hidden flex overflow-hidden">
            <IntroCarousel >
                <IntroSlide>
                  <div style={styleBg("development.jpg")} className="intro-bg-mobile w-full" />
                </IntroSlide>
                
                <IntroSlide>
                  <div style={styleBg("CoU-BRACNet.jpg", "center")} className="intro-bg-mobile w-full" />
                </IntroSlide>
                
                <IntroSlide>
                  <div style={styleBg("Intro_image_1.jpg", "center")} className="intro-bg-mobile w-full" />
                </IntroSlide>

                <IntroSlide>
                  <div style={styleBg("ctf_champion.jpg")} className="intro-bg-mobile w-full" />
                </IntroSlide>
                
                <IntroSlide>
                  <div style={styleBg("inter-iut-pc.jpg")} className="intro-bg-mobile w-full" />
                </IntroSlide>
                
                <IntroSlide>
                  <div style={styleBg("hackathon_IUT_Pixel.jpg")} className="intro-bg-mobile w-full" />
                </IntroSlide>
              </IntroCarousel>
          </div>
      </div>
